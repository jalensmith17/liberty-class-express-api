...
//         if (!user) throw new Error('No user found with give id. Do you think they were deleted?')
//         const foundPost = await Post.findOne({ '_id': req.body.postId})
//         id (!foundPost) throw new Error('User was valid but there was no post found, was the post deleted?')
